      ...
      <main className="flex-1 w-full">
        ...
        <div className="p-4 sm:p-6 lg:p-8 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-emerald-500 to-blue-500 bg-clip-text text-transparent pb-2">
                Monthly Budget Overview
              </h1>
              ...
              .map((budget, index) => (
                ...
                <BudgetAlert
                  ...
                  description={`You've used ${Math.round(
                    budget.percentage
                  )}% of your budget. $${budget.spent} spent of $${budget.limitAmount}`}
                  isDark={isDark}
                />
