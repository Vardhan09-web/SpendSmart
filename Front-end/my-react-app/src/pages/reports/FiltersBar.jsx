...
export default function FiltersBar({ isDark, onApply }) {
  ...
  return (
    ...
    >
      ...
      {/* Month */}
      <div>
        <label className={`text-sm font-semibold mb-2 block ${isDark ? "text-white" : "text-gray-700"}`}>
          Month
        </label>
        ...
        <select
          ...
          className={`w-full px-4 py-3 rounded-xl border
            ${isDark ? "bg-[#0b1628] border-slate-700 text-white" : "bg-white border-gray-300 text-gray-900"}
          `}
        >
          {MONTHS.map((m) => (
